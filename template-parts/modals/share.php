<div id="product_share" class="open_popup_content white">
        ...
        <div class="form_l">
            <div class="form_top_2">
                <div class="form_top_2_l">
                    <h4>Поделиться</h4>
                    <div class="soc">
                        <a href="https://t.me/share/url?url=<?php echo esc_attr(get_the_permalink()); ?>&text=<?php echo esc_attr(get_the_title()); ?>" target="_blank" title="Share in Telegram">
                        ...
                        <a href="http://vkontakte.ru/share.php?url=<?php echo esc_attr(get_the_permalink()); ?>" target="_blank" title="Share in VK">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="40" height="40" rx="3" fill="#4967D0"></rect>
                        ...
                        <a href="https://api.whatsapp.com/send?text=<?php echo $title; ?>%0A<?php echo esc_attr(get_the_permalink()); ?>" target="_blank" title="Share in WhatsApp">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="40" height="40" rx="3" fill="#4967D0"></rect>
